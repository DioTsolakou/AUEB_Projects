public class BuildingExpense
{
    ...
    public double getEstimatedMonthlyConsumption()
    {
        return estimatedMonthlyConsumption;
    }

    public void setEstimatedMonthlyConsumption(double estimatedMonthlyConsumption)
    {
        this.estimatedMonthlyConsumption = estimatedMonthlyConsumption;
    }
    ...
    public String toString()
    {
        ...
        temp = "BUILDING\n" +
                "{\n" +
                "BUILDING_CODE " + this.getBuilding().getCode() + "\n" +
                "BUILDING_DESCR "  + this.getBuilding().getDescription() + "\n" +
                "ADDRESS " + this.getBuilding().getAddress() + "\n" +
                "SURFACE " + this.getBuilding().getArea() + "\n" +
                "PRICE " + this.getBuilding().getAreaPrice() + "\n" +
